...
knitr::include_graphics(here('docs','data','point_frame_photos','TA3_0to100m.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','TA4_0_2018.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','TA5_0_2018.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','TA6_0_2018.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','TS1_0to100m.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','TS2_0_2018.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','TS3_0to100m.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','TS4_0to100m.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','TSC_0_2018.JPG'))
```
...
```{r ,fig.cap="Independence/Oak Monitoring Site #1",echo=FALSE, cache=TRUE,dpi=30}
knitr::include_graphics(here('docs','data','point_frame_photos','IO1_0to100m.JPG'))
```

Linked pumping wells - 61, 391, 400

Current Status: `r ifelse(awc.req.turnon %>% filter(site == "IO1") %>% select(current.status) == "ON", '<span style="font-weight:bold; color:green;">ON</span>', '<span style="font-weight:bold; color:red;">OFF</span>')` Soil AWC req. for well turn-on: `r awc.req.turnon %>% filter(site == 'IO1') %>% select(AWC.req.turnon)`
...
```{r ,fig.cap="Independence/Oak Monitoring Site #2",echo=FALSE, cache=TRUE,dpi=30}
knitr::include_graphics(here('docs','data','point_frame_photos','IO2_0_2018.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','IC1_0to100m.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','IC2_0_2018.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','SS1_0to100m.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','SS2_0_2018.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','SS3_0to100m.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','SS4_0_2018.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','BG2_0to100m.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','BGC_0to100m.JPG'))
```
