...
Current Status: `r ifelse(awc.req.turnon %>% filter(site == "SS1") %>% select(current.status) == "ON", '[ON]{style="font-weight:bold; color:green;"}', '[OFF]{style="font-weight:bold; color:red;"}')`
