...
knitr::include_graphics(here('docs','data','point_frame_photos','L1_0to100m.JPG'))
...
knitr::include_graphics(here('docs','data','point_frame_photos','LW2_0_2018.JPG'))
...
knitr::include_graphics(here('docs','data','point_frame_photos','LW3_0_2018.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','BC1_0to100m.JPG'))
...
knitr::include_graphics(here('docs','data','point_frame_photos','BC2_0_2018.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','BC3_0_2018.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','BP1_0_2018.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','BP2_0to100m.JPG'))
```
...
knitr::include_graphics(here('docs','data','point_frame_photos','BP3_0to100m.JPG'))
...
knitr::include_graphics(here('docs','data','point_frame_photos','BP4_0_2018.JPG'))

```

Linked pumping wells - 331

Current Status: `r ifelse(awc.req.turnon %>% filter(site == "BP4") %>% select(current.status) == "ON", '[ON]{style="font-weight:bold; color:green;"}', '[OFF]{style="font-weight:bold; color:red;"}')`
